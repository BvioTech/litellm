...
class Router:
    ...
    def _redact_prompt_text_if_needed(
        ...
        redacted: StandardLoggingRoutingDecision = {**routing_decision}
        redacted.pop("signals", None)
        redacted.pop("matched_keyword", None)
        redacted.pop("escalation_keyword", None)
        return redacted
