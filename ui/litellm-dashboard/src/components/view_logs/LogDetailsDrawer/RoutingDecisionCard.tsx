 ...
 */
function describeEscalation(escalated: boolean | undefined, keyword: string | undefined): string {
  if (!keyword) return "Yes";
  return escalated ? `Yes, keyword "${keyword}"` : `Requested via "${keyword}"; already at the highest tier`;
}
